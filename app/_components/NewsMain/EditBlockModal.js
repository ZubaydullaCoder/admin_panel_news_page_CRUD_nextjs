...
const EditBlockModal = ({ isOpen, onClose }) => {
            ...
            <div className="bg-white w-full max-w-[600px] sm:max-w-[800px] overflow-auto scrollbar-hide max-h-[90%]">
                ...
                <div className="mb-4 p-6">
                    ...
                    <div className="relative mb-4">
                        <Image
                            src="/images/News/sample-block1-image.png" // Статическое изображение
                            alt={"Текущее фото блока 1"}
                            width={205}
                            height={120}
                            className="object-cover w-[205px] h-[120px]"
                        />
                        <button
                            className="absolute top-2 left-[22%] bg-white rounded-full p-1 hover:bg-gray-200 cursor-not-allowed"
                            disabled
                            title={'Удалить фото'}
                        >
                            <Image
